...
public class Ejercicio7 {
    ...
    public void atenderPaciente() {
        ...
        if (paciente == null) {
            System.out.printf("No hay ningún paciente con el sip '%s' que este esperando a ser atendido!\n", sip);
        } else {
    ...
    public void altaMedica() {
        ...
        if (paciente == null) {
            System.out.printf("No hay ningún paciente con el sip '%s' siendo atendido para darle el alta!\n", sip);
        } else {
